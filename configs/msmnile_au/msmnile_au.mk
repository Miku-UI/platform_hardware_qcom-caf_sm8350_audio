...
PRODUCT_VENDOR_OVERRIDES += aaudio.mmap_policy=2
#Allow EXCLUSIVE then fall back to SHARED.
PRODUCT_VENDOR_OVERRIDES += aaudio.mmap_exclusive_policy=2
PRODUCT_VENDOR_OVERRIDES += aaudio.hw_burst_min_usec=2000
endif
